...
import com.saini.amit.here_map_example.view.adapter.ResultListAdapter;
...
public class ResultListActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ResultListAdapter listAdapter = new ResultListAdapter(this,
                android.R.layout.simple_list_item_1, BasicMapActivity.s_ResultList);
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        DiscoveryResult result = BasicMapActivity.s_ResultList.get(position);
...
//        resultIntent.putExtra("DISCOVERY_RESULT",geoCoordinate);
        ...
        resultIntent.putExtra("ALT",geoCoordinate.getAltitude());
